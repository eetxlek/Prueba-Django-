...
class MatriculaSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        def validate(self, data):   #drf devuelve un 400 Bad request mediante el def clean.
            # Crear una instancia temporal con los datos recibidos q asegura validar en DRF serializer.is_valid(campo o objeto) que llama internamente a este validate.
            ...
            try:
                ...
                raise serializers.ValidationError(e.message_dict)  # Error se atrapa dentro de DRF y devuelve 400 con detalles
